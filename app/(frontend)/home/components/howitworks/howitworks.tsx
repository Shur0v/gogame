...
export default function HowItWorks() {
  return (
    <div className="w-full h-auto py-12 md:py-24 flex flex-col justify-start items-center gap-8 md:gap-12">
      ...
      <button className="w-full mx-4 md:w-auto px-4 py-2.5 bg-lime-500 rounded-[999px] flex justify-center items-center gap-2.5 hover:bg-lime-600 transition-colors">
